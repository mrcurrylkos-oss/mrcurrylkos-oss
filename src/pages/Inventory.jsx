            ...
            <div className="flex flex-col gap-6 overflow-y-auto pb-20 px-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="bg-surface p-5 rounded-3xl border border-border shadow-sm">
                        ...
                        <p className={`text-3xl font-bold ${lowStockItems > 0 ? 'text-red-400' : 'text-amber-400'}`}>{lowStockItems}</p>
                    </div>
                    <div className="bg-surface p-5 rounded-3xl border border-border shadow-sm">
                            ...
                            <div key={item.id} className="bg-surface p-5 rounded-3xl border border-border shadow-sm hover:shadow-md transition-shadow group relative overflow-hidden">
                                ...
                                <div className="grid grid-cols-4 gap-2">
                                    <button
                                        ...
                                        className="col-span-1 bg-amber-400/10 text-amber-400 hover:bg-amber-400 hover:text-white p-2 rounded-xl flex items-center justify-center transition-colors"
                                        title="Restock"
                                    >
                                        <Plus size={20} />
                                    </button>
                    ...
                    <div className="bg-surface border border-border rounded-3xl p-6 w-full max-w-md shadow-2xl animate-in zoom-in-95 duration-200 max-h-[85vh] overflow-y-auto">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex items-start gap-3">
                                <Plus className="text-amber-400 shrink-0" size={20} />
                                <div>
                                    <p className="text-amber-400 font-bold text-sm">Stock will increase!</p>
                            ...
                            <button
                                ...
                                className="w-full py-4 bg-amber-500 text-white font-bold rounded-xl hover:bg-amber-600 transition-colors mt-4 disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-2"
                            >
                                {isRestocking ? (
                                    <>
                                        <Sparkles className="animate-spin" size={20} />
