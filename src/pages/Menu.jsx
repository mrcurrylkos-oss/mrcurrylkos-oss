                                        ...
                                        {editingPrice ? (
                                            <div className="flex items-center gap-2">
                                                <input
                                                    ...
                                                    autoFocus
                                                />
                                                <button onClick={updatePrice} className="text-amber-400 hover:text-amber-300"><Check size={16} /></button>
                                        ...
                                        {editingCost ? (
                                            <div className="flex items-center gap-2">
                                                <input
                                                    ...
                                                    autoFocus
                                                />
                                                <button onClick={updateCost} className="text-amber-400 hover:text-amber-300"><Check size={16} /></button>
                                            ...
                                            {editingLargePrice ? (
                                                <div className="flex items-center gap-2">
                                                    <input
                                                        ...
                                                        autoFocus
                                                    />
                                                    <button onClick={updateLargePrice} className="text-amber-400 hover:text-amber-300"><Check size={16} /></button>
