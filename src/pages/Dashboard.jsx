...
const Dashboard = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto pt-2 md:pt-4">
            ...
            >
                <img src="/logo.png" alt="MR.Curry" className="h-10 md:h-12 object-contain" />
                <div>
                    <h1 className="text-3xl md:text-5xl font-bold text-text tracking-tight">Good Evening, Chief</h1>
                    <p className="text-text-muted text-base md:text-lg font-medium">Here's what's happening at MR.Curry today.</p>
                </div>
            </motion.header>
