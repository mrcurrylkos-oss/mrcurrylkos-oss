...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        const email = `${username.toLowerCase().replace(/\s+/g, '')}@mrcurry.com`;
        ...
        <div className="min-h-screen flex items-center justify-center bg-bg relative overflow-hidden">
            ...
            >
                <div className="text-center mb-10">
                    <img src="/logo.png" alt="MR.Curry" className="h-16 mx-auto mb-6 object-contain" />
                ...
                <p className="text-center text-text-muted/50 text-sm mt-8">
                    Protected by MR.Curry OS Security
                </p>
            </motion.div>
        </div>
    );
